...
export const MacbookScroll = ({
  ...
  return (
    <div
      ref={ref}
      className="min-h-[120vh]  flex flex-col items-center  justify-start flex-shrink-0 [perspective:800px] transform md:scale-100  scale-[0.35] sm:scale-50"
    >
      <motion.h2
        style={{
...
export const Lid = ({
  ...
  return (
    <div className="relative [perspective:800px]">
      ...
      >
        <div
          className="absolute inset-0 bg-[#272729] rounded-lg bg-no-repeat bg-center bg-cover"
          style={{
